...
return [
    ...
    'division_order_title' => 'Match running order by category',
    'division_order_hint' => 'Usual order in which matches are run: kids and juveniles first (all categories and weights together), then adults/masters by belt. Within each group, gender/age/weight stay roughly as they are. Give each group a number (1 = first).',
