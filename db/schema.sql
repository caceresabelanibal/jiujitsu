...
CREATE TABLE IF NOT EXISTS belts (
  ...
  name_pt VARCHAR(50) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS age_divisions (
  ...
  name_pt VARCHAR(60) NOT NULL DEFAULT '',
...
INSERT INTO belts (code, name_es, name_en, name_pt, color_hex, is_kids, default_duration_sec, sort) VALUES
('white',  'Blanco',  'White',  'Branca', '#f5f5f5', 0, 300, 10),
('blue',   'Azul',    'Blue',   'Azul',   '#1e5bb8', 0, 360, 20),
('purple', 'Violeta', 'Purple', 'Roxa',   '#7b2fbe', 0, 420, 30),
('brown',  'Marrón',  'Brown',  'Marrom', '#6b4423', 0, 480, 40),
('black',  'Negro',   'Black',  'Preta',  '#1a1a1a', 0, 600, 50),
('k_white', 'Blanco (inf.)',  'White (kids)',  'Branca (inf.)', '#f5f5f5', 1, 240, 110),
('k_grey',  'Gris',           'Grey',          'Cinza',         '#8a8a8a', 1, 240, 120),
('k_yellow','Amarillo',       'Yellow',        'Amarela',       '#f2c500', 1, 240, 130),
('k_orange','Naranja',        'Orange',        'Laranja',       '#f28c00', 1, 240, 140),
('k_green', 'Verde',          'Green',         'Verde',         '#2e8b57', 1, 240, 150);

-- Divisiones de edad
INSERT INTO age_divisions (code, name_es, name_en, name_pt, min_age, max_age, is_kids, sort) VALUES
('inf_a',   'Infantil A (4-6)',    'Kids A (4-6)',     'Infantil A (4-6)',        4, 6, 1, 10),
('inf_b',   'Infantil B (7-9)',    'Kids B (7-9)',     'Infantil B (7-9)',        7, 9, 1, 20),
('inf_c',   'Infantil C (10-12)',  'Kids C (10-12)',   'Infantil C (10-12)',     10, 12, 1, 30),
('inf_d',   'Infanto-Juvenil (13-15)', 'Teens (13-15)','Infanto-Juvenil (13-15)',13, 15, 1, 40),
('juvenil', 'Juvenil (16-17)',     'Juvenile (16-17)', 'Juvenil (16-17)',        16, 17, 0, 50),
('adulto',  'Adulto (18-29)',      'Adult (18-29)',    'Adulto (18-29)',         18, 29, 0, 60),
('master1', 'Master 1 (30-35)',    'Master 1 (30-35)', 'Master 1 (30-35)',       30, 35, 0, 70),
('master2', 'Master 2 (36-40)',    'Master 2 (36-40)', 'Master 2 (36-40)',       36, 40, 0, 80),
('master3', 'Master 3 (41-45)',    'Master 3 (41-45)', 'Master 3 (41-45)',       41, 45, 0, 90),
('master4', 'Master 4 (46-50)',    'Master 4 (46-50)', 'Master 4 (46-50)',       46, 50, 0, 100),
('master5', 'Master 5 (51-55)',    'Master 5 (51-55)', 'Master 5 (51-55)',       51, 55, 0, 110),
('master6', 'Master 6 (56+)',      'Master 6 (56+)',   'Master 6 (56+)',         56, NULL, 0, 120);

-- Pesos IBJJF con kimono - Masculino
INSERT INTO weight_classes (gender, code, name_es, name_en, name_pt, max_kg, is_absolute, is_kids, sort) VALUES
('M','m_galo',       'Gallo (-57.5)',        'Rooster (-57.5)',       'Galo (-57.5)',          57.50, 0, 0, 10),
('M','m_pluma',      'Pluma (-64)',          'Light Feather (-64)',   'Pluma (-64)',           64.00, 0, 0, 20),
('M','m_pena',       'Pena (-70)',           'Feather (-70)',         'Pena (-70)',            70.00, 0, 0, 30),
('M','m_leve',       'Leve (-76)',           'Light (-76)',           'Leve (-76)',            76.00, 0, 0, 40),
('M','m_medio',      'Medio (-82.3)',        'Middle (-82.3)',        'Médio (-82.3)',         82.30, 0, 0, 50),
('M','m_mediopesado','Medio Pesado (-88.3)', 'Medium Heavy (-88.3)',  'Meio-Pesado (-88.3)',   88.30, 0, 0, 60),
('M','m_pesado',     'Pesado (-94.3)',       'Heavy (-94.3)',         'Pesado (-94.3)',        94.30, 0, 0, 70),
('M','m_superpesado','Súper Pesado (-100.5)','Super Heavy (-100.5)',  'Super Pesado (-100.5)',100.50, 0, 0, 80),
('M','m_pesadisimo', 'Pesadísimo (+100.5)',  'Ultra Heavy (+100.5)',  'Pesadíssimo (+100.5)',   NULL, 0, 0, 90),
('M','m_absoluto',   'Absoluto',             'Open Class',            'Absoluto',               NULL, 1, 0, 100),
-- Pesos IBJJF con kimono - Femenino
('F','f_galo',       'Gallo (-48.5)',        'Rooster (-48.5)',       'Galo (-48.5)',          48.50, 0, 0, 10),
('F','f_pluma',      'Pluma (-53.5)',        'Light Feather (-53.5)', 'Pluma (-53.5)',         53.50, 0, 0, 20),
('F','f_pena',       'Pena (-58.5)',         'Feather (-58.5)',       'Pena (-58.5)',          58.50, 0, 0, 30),
('F','f_leve',       'Leve (-64)',           'Light (-64)',           'Leve (-64)',            64.00, 0, 0, 40),
('F','f_medio',      'Medio (-69)',          'Middle (-69)',          'Médio (-69)',           69.00, 0, 0, 50),
('F','f_mediopesado','Medio Pesado (-74)',   'Medium Heavy (-74)',    'Meio-Pesado (-74)',     74.00, 0, 0, 60),
('F','f_pesado',     'Pesado (-79.3)',       'Heavy (-79.3)',         'Pesado (-79.3)',        79.30, 0, 0, 70),
('F','f_superpesado','Súper Pesado (+79.3)', 'Super Heavy (+79.3)',   'Super Pesado (+79.3)',   NULL, 0, 0, 80),
('F','f_absoluto',   'Absoluto',             'Open Class',            'Absoluto',               NULL, 1, 0, 100),
-- Infantiles (ambos generos)
('A','k_24', '-24 kg', '-24 kg', '-24 kg', 24.00, 0, 1, 10),
('A','k_27', '-27 kg', '-27 kg', '-27 kg', 27.00, 0, 1, 20),
('A','k_30', '-30 kg', '-30 kg', '-30 kg', 30.00, 0, 1, 30),
('A','k_33', '-33 kg', '-33 kg', '-33 kg', 33.00, 0, 1, 40),
('A','k_36', '-36 kg', '-36 kg', '-36 kg', 36.00, 0, 1, 50),
('A','k_40', '-40 kg', '-40 kg', '-40 kg', 40.00, 0, 1, 60),
('A','k_44', '-44 kg', '-44 kg', '-44 kg', 44.00, 0, 1, 70),
('A','k_48', '-48 kg', '-48 kg', '-48 kg', 48.00, 0, 1, 80),
('A','k_53', '-53 kg', '-53 kg', '-53 kg', 53.00, 0, 1, 90),
('A','k_53p','+53 kg', '+53 kg', '+53 kg',  NULL, 0, 1, 100);
